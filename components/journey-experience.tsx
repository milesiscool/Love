  ...
  return (
    <section className="space-y-8">
      ...
      <div className="animate-fade-in-up" style={{ animationDelay: '200ms' }}>
        <LifeGrid state={liveState} />
      </div>

      <section className="animate-fade-in-up relative overflow-hidden rounded-[2rem] border border-border/80 bg-card/70 p-6 shadow-[0_28px_52px_rgba(98,44,68,0.2)] backdrop-blur-xl" style={{ animationDelay: '300ms' }}>
